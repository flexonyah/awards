...
if($mybb->input['action'] == "awards_search")
{
	...
	$date = my_date($mybb->settings['dateformat'], $awards['awutime']).", ".my_date($mybb->settings['timeformat'], $awards['awutime']);
			...
			$form_container->output_cell("<div style=\"text-align:center\"><a href=\"index.php?module=user-awards&amp;action=awards_delete_user&amp;id={$awards['id']}&amp;awid={$awards['awid']}&amp;awuid={$awards['awuid']}\">Delete</a></div>");
